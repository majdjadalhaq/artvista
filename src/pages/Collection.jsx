...
export default function Collection() {
    ...
    return (
        <div className="min-h-screen bg-charcoal-ink text-dust-sand pt-32 pb-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 mb-16 relative z-10 text-center">
                <motion.div
                    ...
                    className="inline-flex items-center justify-center p-3 mb-6 rounded-full bg-turquoise-core/10 text-turquoise-core border border-turquoise-core/20"
                >
                ...
                <motion.p
                    ...
                    className="text-soft-clay text-lg tracking-wide uppercase font-medium"
                >
